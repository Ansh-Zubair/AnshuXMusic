...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/AimXbots/BrandrdXMusic",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/botsbyprincy")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/princybotsupport")
